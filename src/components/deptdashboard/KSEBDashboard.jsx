...
export default function KSEBDashboard() {
    ...
    onValue(complaintsRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        const filteredComplaints = Object.keys(data)
          ...
          .filter((complaint) => complaint.department === "KSEB"); // Filter PWD complaints
    ...
    <div className="flex">
      ...
      <div className="fixed w-64 h-screen bg-white shadow-md">
        <div className="p-4 border-b">
          <h1 className="text-lg font-bold text-blue-600">KSEB</h1>
        </div>
        <nav className="py-4">
